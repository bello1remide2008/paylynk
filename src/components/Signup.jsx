...
const handleContinue = async (e) => {
  ...
  // Validate inputs
  if (!fullName || !phoneNumber || !form.email || !form.password) {
  ...
  try {
    ...
    alert("Connection to server failed. Check backend.");
  }
};
