...
const ReceiveMoney = () => {
  ...
  useEffect(() => {
    ...
    if (stored.length === 0) {
      const defaultAccount = {
        accountNumber: "PAYLYNK" + Math.floor(Math.random() * 1000000),
        phone: "08000000000",
 ...
 const handleShare = async () => {
  try {
    const shareData = {
      title: "Receive Money on Paylynk",
      text: `Send money to ${activeAccount?.accountNumber} (${activeAccount?.bankName})`,
    };
